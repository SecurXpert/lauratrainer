  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col w-full">
      {!(showAddForm || editingRecord) && (
        <div className="sticky top-0 z-50 bg-gradient-to-br from-gray-50 to-gray-100 px-2 md:px-3 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-transparent">
