...
export const ClassesFilter: React.FC<ClassesFilterProps> = ({
  searchTerm, setSearchTerm, statusFilter, setStatusFilter, dateFilter, setDateFilter, handleResetFilters
}) => {
  return (
    <div className="bg-white rounded-[24px] p-4 sm:p-5 md:p-7 shadow-sm border border-gray-200 mb-6">
      <div className="flex items-center gap-3.5 mb-5 md:mb-6">
        ...
        <div>
          ...
          <p className="text-[12px] md:text-[13px] text-gray-400 font-medium mt-0.5">Refine your Course list</p>
        </div>
      </div>
